        ...
        {isDesktop ? (
          <>
            <div className={styles.productBlock}>
              <img src={seo} alt="product" className={styles.productImage} />
              <div className={styles.productTextBlock}>
                <p className={styles.productTitle}>
                  ПРОФЕССИОНАЛЬНЫЙ БЛОГ <br /> НА WORD PRESS
                </p>
                <p className={styles.price}>
                  76000ТГ <span className={styles.oldPrice}>95000ТГ</span>
                </p>
                ...
                <div className={styles.gradientBackground}>
                  ...
                  <p className={styles.productDescription}>
                    ...
                    Elementum neque mi neque leo tortor enim dui. Semper luctus
                    duis turpis consequat elit eu sit.{" "}
                  </p>
                  <p className={styles.productDescription}>
                    Platea morbi enim eu fusce vitae urna ultrices vitae.
                    Pellentesque varius faucibus quis morbi scelerisque nulla.
                    Pretium neque blandit bibendum aliquam ipsum vitae felis
                    amet enim.
                  </p>
                  <p className={styles.productDescription}>
                    Ante eu sed convallis morbi eget. Facilisis laoreet amet non
                    placerat vitae interdum felis leo. Elementum neque mi neque
                    leo tortor enim dui. Semper luctus duis turpis consequat
                    elit eu sit.
                  </p>
                  <p className={styles.titleDescription}>Как это работает?</p>
                  <p className={styles.productDescription}>
                    Lorem ipsum dolor sit amet consectetur. Eget nibh dolor
                    malesuada ante eu sed convallis morbi eget. Facilisis
                    laoreet amet non placerat vitae interdum felis leo.
